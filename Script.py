class script(object):
    ...
    # HTML टैग क्लोजर और बेहतर बोल्डिंग
    ...
    # कमांड्स में निरंतरता (no trailing periods)
    ADMIN_COMMAND_TXT = """<b>Here is bot admin commands 👇<br><br><br>/index_channels - to check how many index channel id added
